...
GetRequests.prototype.advCommentCard = function(Jcard,callback){
	t.post('/1/cards/'+Jcard.msg_destination+'/actions/comments',{text:Jcard.msg_content},function(err, data) {    		
	if (err) 
	{
		errorHandler (err)
	}else
